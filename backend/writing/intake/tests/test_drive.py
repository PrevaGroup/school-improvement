...
from writing.intake.drive import (DOC_MIME, EXPORT_MIME, FILE_FIELDS, FOLDER_MIME, SCOPES, Drive,
...
def test_a_drive_read_produces_the_same_shape_a_local_read_does():
    ...
    from writing.intake.read_folder import SourceFile, read_drive
...
def test_an_unreadable_drive_file_arrives_as_unreadable_not_as_empty():
    ...
    from writing.intake.read_folder import classify, read_drive
...
def test_a_google_doc_takes_the_plain_text_path_extract_already_documents():
    ...
    from writing.intake.extract import extract
...
def test_the_roster_query_selects_the_address_the_matcher_reads():
    ...
    from writing.intake.read_folder import _ROSTER
