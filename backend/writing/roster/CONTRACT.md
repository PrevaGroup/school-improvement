...
Models: `writing/roster/models.py`. Migration: `0009_roster_tables.py`.
...
Until there is a sync, `python -m writing.roster.grant_staff` writes staff rows by hand — the only way a
