"""Put a person on the staff of a class — the only way anyone reaches student work.
    ...
    python -m writing.roster.grant_staff --email teacher@district.org --section section-11b-period4
    python -m writing.roster.grant_staff --uid <identity platform uid> --section ... --role co_teacher
    python -m writing.roster.grant_staff --email ... --section ... --revoke
    python -m writing.roster.grant_staff --section section-11b-period4 --list
...
`writing/roster/models.py` for why. The `sub` is the Identity Platform uid, which nobody knows by heart, so
