...
from writing.scoring import escalate
from writing.scoring.escalate import DEFAULT_TRIGGERS, NO_LEVEL, Policy, keep, plan, trigger_for
from writing.scoring.rater import RaterIdentity
from writing.scoring.score import Outcome
...
class TwoPassRater:
    ...
    def propose_spans(self, prompt):
        from writing.scoring.rater import Usage
...
def test_escalation_is_reachable_from_the_scoring_run():
    ...
    from writing.scoring.run_scoring import escalate_pass
    from writing.scoring.rater import RaterIdentity
    from writing.scoring.score import Criterion
...
def test_the_escalated_event_supersedes_the_first_pass_and_says_what_fired():
    ...
    from writing.scoring.rater import RaterIdentity
    from writing.scoring.run_scoring import ESCALATED_PASS, SCRUTINY_PASS, event_rows
...
def test_measurement_can_already_separate_the_two_passes():
    """`include_escalated` and the scrutiny bounds have been in `writing/measurement/frames.py` since it
    ...
    two instruments."""
    from writing.measurement.frames import admits
