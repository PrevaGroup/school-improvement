...
from writing.scoring import seed_demo
from writing.scoring.prompts import render_scale
from writing.scoring.score import Criterion, build_evidence_prompt
...
def test_the_purge_deletes_every_table_that_references_an_artifact():
    ...
    import writing.scoring.models  # noqa: F401
...
def test_the_purge_only_asks_a_table_for_columns_it_has():
    ...
    from app.models import Base
    import writing.delivery.models, writing.intake.models, writing.scoring.models  # noqa: F401

    from writing.scoring.seed_demo import (_BY_ARTIFACT, _BY_ARTIFACT_WIDE, _BY_RUN, _BY_RUN_OR_INTAKE,
                                   _PURGE_ORDER)
