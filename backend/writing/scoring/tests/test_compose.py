...
from writing.scoring.compose import (COMPOSER_VERSION, _PRIOR, build_packet, configuration_of,
...
def test_any_hold_at_all_routes_to_blocked():
    ...
    from writing.scoring.feedback import Hold
...
def test_blocked_is_a_state_a_teacher_can_leave():
    ...
    from writing.scoring.models import ARTIFACT_TRANSITIONS
