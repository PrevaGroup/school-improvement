...
from writing.scoring.bind import BINDABLE, decide, initial_state, resolution_path
...
def test_the_gate_and_the_finished_are_counted_separately():
    ...
    """
    from writing.scoring.bind import _HELD, _PENDING
...
def test_the_summary_names_the_folder_a_teacher_has_to_go_and_confirm():
    ...
    import inspect
    from writing.scoring import bind
