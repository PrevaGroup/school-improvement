...
from writing.scoring.models import (ARTIFACT_STATES, ARTIFACT_TRANSITIONS, TERMINAL_STATES)
...
def test_migration_copy_of_the_transitions_has_not_drifted():
    ...
    assert _migration()._TRANSITIONS == ARTIFACT_TRANSITIONS, (
        "writing/scoring/models.py ARTIFACT_TRANSITIONS and 0008's _TRANSITIONS disagree. "
