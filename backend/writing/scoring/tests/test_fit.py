...
from writing.scoring.fit import ADMIT, NOT_THIS_TASK, REFUSE, Verdict, check, decide
from writing.scoring.prompts import FIT_PROMPT, FIT_SCHEMA
...
def test_a_gated_paper_says_it_was_the_wrong_task_not_that_it_was_empty():
    ...
    from writing.scoring.score import EMPTY_DOCUMENT
