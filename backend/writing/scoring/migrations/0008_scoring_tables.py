...
# Mirrors writing/scoring/models.py ARTIFACT_TRANSITIONS. Duplicated deliberately: a migration must be
# readable and runnable at the revision it was written, without importing code that has since
# moved. backend/writing/scoring/tests/test_state_machine.py asserts the two agree.
_TRANSITIONS = {
