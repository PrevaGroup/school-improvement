...
from writing.measurement.corpus_agreement import _SPAN_TYPE, aggregate, measure, report
...
def test_every_element_trait_maps_to_a_span_type():
    ...
    from writing.registry.persuade_rubrics import evidence_trait, shared_element_traits
...
def test_the_holistic_trait_is_not_in_the_span_map():
    ...
    from writing.registry.persuade_rubrics import holistic
...
def test_the_rater_comes_from_the_configuration_that_scored_it():
    ...
    from writing.measurement.corpus_agreement import rater_of
