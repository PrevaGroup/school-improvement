...
The estimator arrived with Phase 6 (`writing/measurement/mfrm.py`): person and rater measures, fit
...
Models: `writing/measurement/models.py`. Resolver: `writing/measurement/frames.py`. Migration: `0010_measurement_frames.py`.
