...
from writing.delivery.deliver import (CHANNELS, DeliveryFailed, attempt_row, message_of, send_to_file,
                              send_to_nowhere)
from writing.delivery.models import CHANNELS as MODEL_CHANNELS, DELIVERY_STATUSES
...
def test_the_module_and_the_migration_agree_on_the_vocabulary():
    ...
    from writing.delivery.migrations import __name__ as _  # noqa: F401
...
def test_the_queue_asks_whether_this_composition_was_sent():
    ...
    """
    from writing.delivery.deliver import _PENDING
