...
def test_a_paper_id_is_derived_not_generated():
    ...
    from writing.corpus._shared import paper_id_for
...
def test_scores_and_spans_are_replaced_rather_than_upserted():
    ...
    beside the new one."""
    from writing.corpus._shared import _CLEAR_SCORES, _CLEAR_SPANS
...
def test_the_raw_row_never_reaches_the_insert():
    ...
    from writing.corpus import _shared
...
def test_a_gs_uri_is_readable_without_a_local_copy():
    ...
    from writing.corpus._shared import open_rows
...
def test_a_duplicate_external_id_is_skipped_not_silently_replaced():
    ...
    from writing.corpus._shared import CorpusSpec, run_corpus_loader
    ...
    import writing.corpus._shared as sh
...
def test_an_overlap_can_name_a_corpus_that_is_not_loaded():
    ...
    from writing.corpus.models import CorpusSource
...
def test_every_column_the_paper_insert_names_exists_on_the_table():
    ...
    from writing.corpus._shared import _PAPER
    from writing.corpus.models import CorpusPaper
...
def test_the_mapper_supplies_every_parameter_the_insert_binds():
    ...
    from writing.corpus._shared import _PAPER
    from writing.corpus.load_persuade import _paper
