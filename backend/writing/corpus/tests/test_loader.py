...
from writing.corpus._shared import (VALIDATION_SHARE, blank_to_none, partition_for, text_hash)
from writing.corpus.load_persuade import SPEC, _paper, _scores, _span
from writing.corpus.models import DISCOURSE_TYPES, PARTITIONS
...
@pytest.mark.parametrize("module", ["writing/corpus/_shared.py", "writing/corpus/load_persuade.py",
                                     "writing/corpus/models.py", "writing/registry/persuade_rubrics.py",
                                     "writing/registry/seed_persuade.py"])
def test_no_licence_is_named_anywhere_in_the_loaders(module):
    ...
    """
    src = (pathlib.Path(__file__).resolve().parents[3] / module).read_text(encoding="utf8")
...
def test_real_corpus_conforms():
    from writing.corpus._shared import rows
...
def test_both_columns_reach_the_upsert():
    ...
    from writing.corpus._shared import _PAPER
