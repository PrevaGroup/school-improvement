...
from writing.registry.lint import (ADVISORY, BLOCKING, Registry, blocks_publication, lint)
...
def test_a_list_still_counts_as_stacked():
    from writing.registry.lint import count_judgments
...
def test_persuade_holistic_descriptors_are_flagged_and_element_ones_are_not():
    ...
    from writing.registry.lint import count_judgments
    from writing.registry.persuade_rubrics import distinct_traits
...
def test_the_finding_says_the_descriptor_was_prose():
    ...
    from writing.registry.lint import ADVISORY, Finding, check_stacked_conditionals
