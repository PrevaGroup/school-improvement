...
from writing.registry import seed_persuade
from writing.registry.persuade_rubrics import all_rubrics, distinct_traits
...
def test_a_site_exists_for_every_corpus_iteration():
    ...
    from writing.registry.seed_persuade import CORPUS_ITERATIONS
...
def test_the_task_ids_match_the_binder():
    ...
    from writing.registry.seed_persuade import CORPUS_TASK_PREFIX
    from writing.scoring.bind_corpus import TASKS
...
def test_the_site_names_all_eight_traits_for_its_form():
    ...
    from writing.registry.persuade_rubrics import elements, holistic
...
def test_the_adapted_trait_is_the_only_one_that_says_adapted():
    from writing.registry.persuade_rubrics import ADAPTED
