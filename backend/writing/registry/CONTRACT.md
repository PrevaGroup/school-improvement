...
Models: `writing/registry/models.py`. Linter: `writing/registry/lint.py`. Seed + publication: `writing/registry/seed_demo.py`.
...
two severity classes exist to preserve. A CHECK refuses a reason under twelve characters.
    ...
    python -m writing.registry.seed_demo --acknowledge RULE SUBJECT REASON BY
