"""Publish PERSUADE 2.0's four rubrics into the registry.
    ...
    python -m writing.registry.seed_persuade [--dry-run]

The instruments themselves are data in `writing/registry/persuade_rubrics.py`, transcribed from the rating
