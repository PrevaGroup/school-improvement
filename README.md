...
| Path | What |
|---|---|
| [`docs/GO_LIVE_PLAN.md`](docs/GO_LIVE_PLAN.md) | **The plan to put this on the internet** — Identity Platform sign-in, the `frontend/` SPA, the domain, and why the gate opens last |
